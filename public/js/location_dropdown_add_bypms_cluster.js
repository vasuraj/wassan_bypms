...
$(function() {
    ...
    console.log('route address in location_dropdown_add_bypms_cluster.js is:'+route_address);
    ...
    console.log('state selected is '+selected_state_name);
     console.log("asset img is set to in location_dropdown_add_bypms_cluster.js : "+asset_img);
                                            ...
                                            */
                                             ...
                                             $.ajax({
                                                ...
                                                success: function(data){
                                                    ...
                                                    /*========================
                                                    *   refresh village multipicker
                                                    ==========================*/

                                                    console.log("After loading village list refreshing multiselect on change in state dropdown");
                                                  //  alert("alert in change state code "+data);
                                                    $("#village_area_multiselect_list").html(data);
                                            ...
                                            success: function(data){
                                                ...
                                                $( "#village_area" ).html(data).fadeIn();
                                                    ...
                                                    *   refresh village multipicker
                                                    ...
                                                    console.log("After loading village list refreshing multiselect on change in district dropdown");
                                                  //  alert("alert in change district code "+data);
                                                    $("#village_area_multiselect_list").html(data);
                                            ...
                                            success: function(data){
                                                ...
                                                /*========================
                                                    *   refresh village multipicker
                                                    ...
                                                    console.log("After loading village list refreshing multiselect on change in mandal dropdown");
                                                  //  alert("alert in change mandal code "+data);
                                                    $("#village_area_multiselect_list").html(data);
                                            ...
                                            success: function(data){
                                                ...
                                                // $( "#village_area" ).html(data).fadeIn();
                                                    ...
                                                    *   refresh village multipicker
                                                    ...
                                                    // console.log("After loading village list refreshing multiselect on change in panchayat dropdown");
                                                   
                                                    // alert("alert in change panchyat code "+data);

                                                    // console.log("alert in change panchyat code "+data);
                                                ...
                                                if($("#village_area_multiselect_list").length){
                                                       var selected_panchayat_id=$( "#panchayat option:selected" ).attr('data-id');       
                                                                var village_list=route_address+'/locations/get_village_multiselect/'+selected_panchayat_id;
                                                               
                                                                $.get(village_list,function(data){
                                                               //   alert(data);
