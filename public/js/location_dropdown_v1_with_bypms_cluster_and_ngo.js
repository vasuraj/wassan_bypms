                ...
                ====================================================================*/
                    ...
                    if(selected_district_id!='')
                    {
                     ...
                     console.log('getting_Mandals_list');
                        ...
                        /*
                        *   Ajax request for NGO in selected NGO
                        *
                        */
                         var ngos_list_url=base_url+'/'+sub_domain+'/locations/get_ngos_dropdown/'+selected_district_name;
                                ...
                                $.ajax({
                                    ...
                                    cache: false,
                                    success: function(data){
                                    console.log('While loading ngoss....');
                                    console.log(loader_img_url);
                                    ...
                                    .fadeOut('slow',function(){
                                        ...
                                        $( "#ngo_area" ).html(data).fadeIn();
                                        console.log('ngo list loadeding finished');

                                    }); //ngo Dropdown Fading animation ends here
                                }
                            });
                       

                       // ngos ajax reuqest ends here
