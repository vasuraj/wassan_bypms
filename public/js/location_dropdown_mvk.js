...
$( "#mvk_area" ).html('<img class="loader"   src="'+base_url+sub_domain+'/images/horizontal_loader.gif" alt="" />');
...
$( "#habitation_area" ).html('<img class="loader"   src="'+base_url+sub_domain+'/images/horizontal_loader.gif" alt="" />');
    ...
    $( "#district_area" ).html('<img class="loader"  src="'+base_url+sub_domain+'/images/horizontal_loader.gif" alt="" />').fadeOut('slow',function(){
    ...
    $( "#district_area" ).html(data).fadeIn();
         ...
         $.get(mandals_list, function( data ) {
            $( "#mandal_area" ).html('<img class="loader"  src="'+base_url+sub_domain+'/images/horizontal_loader.gif" alt="" />').fadeOut('slow',function(){
            ...
            $( "#mandal_area" ).html(data).fadeIn();
                ...
                var mvks_list=route_address+'locations/get_mvks_dropdown/'+selected_mandal_id;
                console.log('query on: '+mvks_list);
                $.get(mvks_list, function( data ) {
                  $( "#mvk_area" ).html('<img class="loader"  src="'+base_url+sub_domain+'/images/horizontal_loader.gif" alt="" />').fadeOut('slow',function(){
    
                    $( "#mvk_area" ).html(data).fadeIn();
                ...
                $.get(panchayats_list, function( data ) {
                  $( "#panchayat_area" ).html('<img class="loader"  src="'+base_url+sub_domain+'/images/horizontal_loader.gif" alt="" />').fadeOut('slow',function(){
                    ...
                    $( "#panchayat_area" ).html(data).fadeIn();
                        ...
                        $.get(villages_list, function( data ) {
                          $( "#village_area" ).html('<img class="loader"  src="'+base_url+sub_domain+'/images/horizontal_loader.gif" alt="" />').fadeOut('slow',function(){
                            ...
                            $( "#village_area" ).html(data).fadeIn();
                                ...
                                $.get(habitations_list, function( data ) {
                                 $( "#habitation_area" ).html('<img class="loader"  src="'+base_url+sub_domain+'/images/horizontal_loader.gif" alt="" />').fadeOut('slow',function(){
   ...
   // $('option:selected', this).attr('mytag');
    ...
    $( "#mandal_area" ).html(data);
        ...
        var selected_mandal_id=$( "#mandal option:selected" ).attr('data-id');     
                ...
                var selected_mvk_id=$( "#mvk option:selected" ).attr('data-id');     
                var selected_mvk_name=$( "#mvk option:selected" ).text().trim();
                console.log('selected mvk is '+selected_mandal_name);

                var panchayats_list=route_address+'/locations/get_mvk_panchayats_dropdown/'+selected_mvk_id;
                console.log('query on: '+panchayats_list);
                $.get(panchayats_list, function( data ) {
...
$(document).on('change',"select#mvk",function(){
$( "#panchayat_area" ).html('<img class="loader"   src="'+base_url+sub_domain+'/images/horizontal_loader.gif" alt="" />');
$( "#village_area" ).html('<img class="loader"   src="'+base_url+sub_domain+'/images/horizontal_loader.gif" alt="" />');
$( "#habitation_area" ).html('<img class="loader"   src="'+base_url+sub_domain+'/images/horizontal_loader.gif" alt="" />');
                ...
                var selected_mvk_id=$( "#mvk option:selected" ).attr('data-id');     
                var selected_mvk_name=$( "#mvk option:selected" ).text().trim();
                console.log('selected mvk is '+selected_mvk_name);
