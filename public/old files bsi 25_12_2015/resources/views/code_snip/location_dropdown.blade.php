...
<select class="form-control form-group" name="mandal" id="mandal">
 ...
 <option value='{{$mandal->name}}'  data-id="{{$mandal->id}}" @if(isset($user)) @if($mandal->name==$user->mandal)   selected @endif  @endif >
...
<select class="form-control form-group" name="village" id="village">
 ...
 <option value='{{$village->name}}'  data-id="{{$village->id}}"  @if(isset($user))  @if($village->name==$user->village)   selected @endif  @endif >
