...
class NgosController extends Controller {
	...
	public function create()
	{
		...
		$data['mvks']=DB::table('mvks')->select('id','name')->orderby('name')->get();
		return view('ngos.create',$data);
	}
...
//		echo $state."|".$district."|".$mandal."|".$village;
	...
	public function getSelectiveNgo($state=null, $district=null, $mandal=null, $mvk=null, $panchayat=null, $village=null, $habitation=null)
	{
		$ngos_list=array();
		// echo $state;
		// echo $district;
		...
		elseif ($state!='' && $district!='' && $mandal!='' && $mvk!='' && ($panchayat=='' || $panchayat=='Do Not Mention') && ($village=='' || $village=='Do Not Mention') && ($habitation=='' || $habitation=='Do Not Mention')) 
		{
			if(isset(Session::all()['user_details']))
			{
			$ngos_list=DB::table('ngos')->where('entered_by_id',Session::all()['user_details']->id)->where('state',$state)->where('district',$district)->where('mandal',$mandal)->where('mvk',$mvk)->get();

			}
			else
			{
			$ngos_list=DB::table('ngos')->where('state',$state)->where('district',$district)->where('mandal',$mandal)->where('mvk',$mvk)->get();
		...
		elseif ($state!='' && $district!='' && $mandal!='' && $mvk!='' && $panchayat!=''  && ($village=='' || $village=='Do Not Mention') && ($habitation=='' || $habitation=='Do Not Mention')) 
		{
			if(isset(Session::all()['user_details']))
			{
			$ngos_list=DB::table('ngos')->where('entered_by_id',Session::all()['user_details']->id)->where('state',$state)->where('district',$district)->where('mandal',$mandal)->where('mvk',$mvk)->where('panchayat',$panchayat)->get();

			}
			else
			{
			$ngos_list=DB::table('ngos')->where('state',$state)->where('district',$district)->where('mandal',$mandal)->where('mvk',$mvk)->where('panchayat',$panchayat)->get();
		...
		elseif ($state!='' && $district!='' && $mandal!='' && $mvk!='' && $panchayat!=''  && $village!='' && ($habitation=='' || $habitation=='Do Not Mention')) 
		{
			if(isset(Session::all()['user_details']))
			{
			$ngos_list=DB::table('ngos')->where('entered_by_id',Session::all()['user_details']->id)->where('state',$state)->where('district',$district)->where('mandal',$mandal)->where('mvk',$mvk)->where('panchayat',$panchayat)->where('village',$village)->get();

			}
			else
			{
			$ngos_list=DB::table('ngos')->where('state',$state)->where('district',$district)->where('mandal',$mandal)->where('mvk',$mvk)->where('panchayat',$panchayat)->where('village',$village)->get();
		...
		elseif ($state!='' && $district!='' && $mandal!='' && $mvk!='' && $panchayat!=''  && $village!='' && $habitation!='') 
		{
			if(isset(Session::all()['user_details']))
			{
			$ngos_list=DB::table('ngos')->where('entered_by_id',Session::all()['user_details']->id)->where('state',$state)->where('district',$district)->where('mandal',$mandal)->where('mvk',$mvk)->where('panchayat',$panchayat)->where('village',$village)->where('habitation',$habitation)->get();

			}
			else
			{
			$ngos_list=DB::table('ngos')->where('state',$state)->where('district',$district)->where('mandal',$mandal)->where('mvk',$mvk)->where('panchayat',$panchayat)->where('village',$village)->where('habitation',$habitation)->get();
