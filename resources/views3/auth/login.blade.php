  ...
  data-animsition-out="fade-out">
    <div class="page-content vertical-align-middle">
      <div class="brand">
        ...
        <h2 class="brand-text">COMMUNITY MANAGED SEED SYSTEM</h2>
      </div>
      <p>Sign into your CMSS account</p>
...
-->
  ...
  {!! Form::open(array('url'=>'auth/login', 'method'=>'post', 'class'=>'demo', 'style'=>'margin:auto;')) !!}
    ...
    {!! Form::password('password',array('class'=>'form-control form-group ', 'placeholder'=>'Password')) !!}
...
-->
      ...
      <!-- <p>Apply for a new account <a href="{{url('auth/register')}}">Here</a></p> -->

      <footer class="page-copyright" style="margin-top:10px;">
