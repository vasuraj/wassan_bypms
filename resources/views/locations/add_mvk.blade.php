	              ...
	              <div class="wizard-content">
	                <div class="wizard-pane active" id="location-details" role="tabpanel">
	                  <form id="location-form">
	   				  ...
	   				  @include('code_snip.location_dropdown_add_mvk')
	                 ...
	                 <div class="form-group ">
	                      ...
	                      <input type="text" class="form-control " id="mvk_name" name="mvk_name" placeholder="mvk name">
	                </div>
 				</form>
	                </div>
	              </div>
...
$('.selectpicker').selectpicker('refresh');
      ...
      (function() {
		...
		var url=route_address+"locations/add_mvk";
