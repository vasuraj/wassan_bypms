...
@yield('head')
 ...
 padding:3px 10px;
  ...
  <script>
    ...
    /*
    * Set base_url in javascript - get it form Config folder in App.blade
    */

         var base_url = window.location.origin;
        // var base_url="{{Config('app.url')}}";
        console.log("base_url assigned to : "+base_url);
    /*
    * Set sub_domain in javascript if there is any get it form Config folder in app.blade
    */

        var sub_domain='{{Config("app.sub_domain")}}';
        console.log("sub_domain assigned to : "+sub_domain);

    /*
    * Set route_address
    */ 
   
      var route_address="{{Config('app.url')}}";

      console.log("route_address assigned to : "+route_address);
    ...
    */ 
      ...
      var asset_img="{{asset('/images/')}}";

      console.log("asset_img assigned to : "+asset_img); 
    ...
    */ 
      ...
      var loader_img_url="{{asset('/images/horizontal_loader.gif')}}";

      console.log("loader_img_url assigned to : "+loader_img_url); 
    ...
    */ 
      ...
      console.log("csrf_token set to : "+csrf_token); 
...
<script>
    ...
    $(function(){
      @if(Session::has('status'))
        new PNotify({
            title: "{{Session::get('status_title')}}",
            type:"{{ Session::get('status_type')}}",
...
xOffset:200,
      ...
      @yield('tour')
        ...
        {
          title: "Your Account",
          content: "Get your account details from here",
          target: document.querySelector(".avatar"),
          width:250,
          placement: "left"
        },
