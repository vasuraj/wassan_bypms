...
@section('content')
	              ...
	              <div class="wizard-content">
	                <div class="wizard-pane active" id="location-details" role="tabpanel">
	                  <form 	 id="location-form">
	   				 ...
	   				 @include('code_snip.location_dropdown_for_edit') 
	   				<?php
	   				if(isset($ngo))
	   				{
	   				//	print_r($ngo);
	                   ...
	                   <div class="col-md-9">
						<div class="row">	
		                    <div class="form-group col-md-9">
		                      ...
		                      <input type="text" class="form-control " id="name" name="name" value='{{$ngo->name}}' placeholder="name">
		                    </div>

		                     <div class="form-group col-md-3">
		                      <label class="control-label" for="name">Registration No</label>
		                      <input type="text" class="form-control " id="registration_number" value='{{$ngo->registration_number}}'  name="registration_number" placeholder="Registartion Number">
		                    </div>
	                    ...
	                    <div class="form-group ">
	                      ...
	                      <input type="text" class="form-control " id="full_address" name="full_address" value='{{$ngo->full_address}}' placeholder="NGO address">
	                    </div>
	                  </div>
	                  </div>
     ...
     <div class="row">
	                    ...
	                    <div class="form-group">
	                      ...
	                      <input type="text" class="form-control" id="HON" value="{{$ngo->HON}}" name="HON" placeholder="Name of the Head of the ngo">
	                    </div>
		                ...
		                <div class="radio-custom radio-primary" style="display:inline-block;">
		                  <input type="radio" id="inputRadiosChecked" name="gender_HON" value="male" @if($ngo->gender_HON=='male') checked="checked" @endif>
		                  <label for="inputRadiosChecked">Male</label>
		                </div>

		                <div class="radio-custom radio-primary" style="display:inline-block;">
		                  <input type="radio" id="inputRadiosUnchecked" name="gender_HON" value="female" @if($ngo->gender_HON=='female') checked="checked" @endif>
						...
						<div class="row">
	                      ...
	                      <input type="text" class="form-control" id="contact_number" name="contact_number" value="{{$ngo->contact_number_HON}}" placeholder="contact number for Head of the Ngo">
	                    </div>
	                     
	                     <div class="form-group col-md-6">
	                      <label class="control-label" for="email">email</label>
	                      <input type="text" class="form-control" id="email" name="email" value="{{$ngo->email_HON}}" placeholder="Email address for Head of the Ngo">
	                    </div>
      					</div>      					
	                  </div>    	
		                   ...
		                   <div class="col-md-4 photograph_passport_size" id="field_incharge_image" style="margin-left:10px; overflow:hidden;">
		                   	    	<img src="{{$ngo->field_incharge_image}}" alt="">
		                    ...
		                    <div class="form-group col-md-10">
	                      	...
	                      	<input type="text" class="form-control" id="field_incharge" value="{{$ngo->field_incharge}}"name="field_incharge" placeholder="Name of the field incharge">
	                    	

	                    	<div class="gender_area_field_incharge">
	              
			                <div class="radio-custom radio-primary" style="display:inline-block;">
			                  <input type="radio" id="inputRadiosChecked" name="gender_field_incharge" value="male" @if($ngo->gender_field_incharge=='male') checked="checked" @endif>
			                  <label for="inputRadiosChecked">Male</label>
			                </div>

			                <div class="radio-custom radio-primary" style="display:inline-block;">
			                  <input type="radio" id="inputRadiosUnchecked" name="gender_field_incharge" value="female" @if($ngo->gender_field_incharge=='female') checked="checked" @endif>
			                  <label for="inputRadiosUnchecked">Female</label>
			                </div>
	                      	...
	                      	<div class="row">
			                   <div class="form-group col-md-6" >
			                      ...
			                      <input type="text" class="form-control" id="contact_number_incharge" name="" value="{{$ngo->contact_number_incharge}}"  placeholder="contact number for incharge person">
		                    	</div>
	                     
			                     <div class="form-group col-md-6">
			                      <label class="control-label" for="email_inchrage">Incharge email</label>
			                      <input type="text" class="form-control" id="email_incharge" name="email_incharge" value="{{$ngo->email_incharge}}" placeholder="Email address for Incharge">
			                    </div>
		                    </div>
      				</div>
...
var logo_image='{{$ngo->logo_image}}';
var HON_image='{{$ngo->HON_image}}';
var field_incharge_image='{{$ngo->field_incharge_image}}';
