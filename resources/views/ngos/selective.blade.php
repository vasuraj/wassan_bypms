...
$("#ngos_report").parent().parent().addClass('open');
$("#ngos_view").parent().parent().addClass('active bold active_3d');
   ...
   <div class="col-md-12" style="height:auto;">
            ...
            <div class="panel" id="wizard-form">
              <div class="panel-heading">
                <h3 class="panel-title">Search NGOs by location</h3>
              </div>
...
@section('tour')

  {
          ...
          content: "Here you can get select location to filter NGOs",
...

   {
         ...
         target: document.querySelector(".loader_area"),
         placement: "top",
         yOffset:-12
        },
  ...
  $(function(){
      ...
      $('#get_records').on('click',function(){
        ...
        var selected_state_name=$( "#state option:selected" ).text().trim();
          ...
          var url=route_address+'ngo/getselective/'+selected_state_name+'/'+selected_district_name+'/'+selected_mandal_name+'/'+selected_panchayat_name+'/'+selected_village_name+'/'+selected_habitation_name;
      ...
      if(data!='')
      {
         $('#ngos_table').dataTable().fnDestroy();
        console.log("Ngos data is not empty");
        $("#records_datatable_tbody").html(data);
              ...
              var table = $('#ngos_table').DataTable({
               ...
               console.log("Ngos data is empty");
...
request.fail(function(){
 console.log("request faild while fatching Ngos list filtered by selected lcoation");
});
