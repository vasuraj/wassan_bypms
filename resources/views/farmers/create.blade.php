...
$("#cmss_farmers_create").parent().parent().addClass('active bold active_3d');
	        ...
	        <div class="col-md-12" style="height:auto;">
	          ...
	          <div class="panel" id="wizard-form">
	            <div class="panel-heading">
	              ...
	              <h3 class="panel-title">Farmer Details 
			<div class="panel-title-small">
			@if($farmers_location_insert['state'][0]!='')
			<a class="btn btn-default" href="{{URL::to('locations/reset_location/insert_farmer')}}" style="float:right; margin-top:-20px;">Enter New Address</a>
			
				{{$farmers_location_insert['state'][0]}}			
				@if($farmers_location_insert['district'][0]!='')
					->{{$farmers_location_insert['district'][0]}}
					@if($farmers_location_insert['mandal'][0]!='')
						->{{$farmers_location_insert['mandal'][0]}}
						@if(isset($farmers_location_insert['mvk'][0]) && $farmers_location_insert['mvk'][0]!='')
							->{{$farmers_location_insert['mvk'][0]}}
							@if(isset($farmers_location_insert['panchayat'][0]) && $farmers_location_insert['panchayat'][0]!='')
								->{{$farmers_location_insert['panchayat'][0]}}
								@if(isset($farmers_location_insert['village'][0]) && $farmers_location_insert['village'][0]!='')
									->{{$farmers_location_insert['village'][0]}}
									@if($farmers_location_insert['habitation'][0]!='')
									->{{$farmers_location_insert['habitation'][0]}}
									@endif
								@endif			
							@endif
						@endif
			...
			@endif
	            ...
	            <div class="panel-body">
	              ...
	              <div class="steps steps-sm row" data-plugin="matchHeight" data-by-row="true" role="tablist">
	                ...
	                <div class="step col-md-6" data-target="#basic-details" role="tab">
	                ...
	                <div class="step col-md-6" data-target="#advance-details" role="tab">
	              ...
	              <div class="wizard-content">
	                ...
	                <div class="wizard-pane" id="basic-details" role="tabpanel">
					  ...
					  <div class="row">
    				    <div class="col-md-4" id="farmer_image" style="margin-left:10px; "></div>
	         ...
	         <div class="wizard-pane" id="advance-details" role="tabpanel">
				<form id="advance-details-form"  action="">
	                    ...
	                    <div class="form-group col-md-6">
  						...
  						<div class="form-group col-md-6">
	                      <label class="control-label col-md-6" for="survey_number">Survey Number</label>
...
var farmer_image_upload_option = {
  ...
  $("#advance-details-form").formValidation({
		...
		$.ajax({
	        ...
	        'state':'{{ $farmers_location_insert["state"][0]}}',
	        'district':'{{ $farmers_location_insert["district"][0]}}',
	        'mandal':'{{ $farmers_location_insert["mandal"][0]}}',
	        'mvk':'@if(isset($farmers_location_insert["mvk"][0])){{ $farmers_location_insert["mvk"][0]}}@endif',
	        'panchayat':'@if(isset($farmers_location_insert["panchayat"][0])){{ $farmers_location_insert["panchayat"][0]}}@endif',
	        'village':'@if(isset($farmers_location_insert["village"][0])){{ $farmers_location_insert["village"][0]}}@endif',
	        'habitation':'@if(isset($farmers_location_insert["habitation"][0])){{ $farmers_location_insert["habitation"][0]}}@endif',
	        'name':$("#name").val(),
	        'fname':$("#fname").val(),
