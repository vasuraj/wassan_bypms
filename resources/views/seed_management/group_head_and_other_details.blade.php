...
$("#seed_management_enter_data").parent().parent().addClass('open');

$("#seed_management_{{$form_name}}").parent().parent().addClass('active bold active_3d');
	            ...
	            <div class="panel-heading">
	              <h3 class="panel-title">{{str_replace('_',' ',$form_name)}} Details</h3>
	               ...
	               <div class="wizard-pane active"  style="padding:20px;" id="location-details" role="tabpanel">
			        ...
			        <div id="iframe_area">
					<iframe src="#" frameborder="0" id="result_iframe" name="result_iframe" style="width:100%; min-height:100%; display:none;"></iframe>
					</div>
	                </div>
...
<script>
    ...
    var route_address=base_url+sub_domain+'/';
      ...
      (function() {
		...
		var url=route_address+"seed_management/farmers_group_list";
