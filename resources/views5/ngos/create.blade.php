	            ...
	            <div class="panel-body">
	              ...
	              <div class="wizard-content">
	                ...
	                <div class="wizard-pane" id="basic-details" role="tabpanel">
	                  ...
	                  <div class="row">
    					<div class="col-md-4" id="ngo_logo" style="margin-left:10px; height:120px;"></div>
						...
						<div class="row">	
		                    <div class="form-group col-md-9">
		                     ...
		                     <div class="form-group col-md-3">
		                      ...
		                      <input type="text" class="form-control " id="registration_number" required  name="registration_number" placeholder="Registartion Number">
		                    </div>
	                  ...
	                  <div class="form-group" id="name_area">
						...
						<select multiple class="selectpicker" 	id="mvk_multiselect_list" 
						data-plugin="selectpicker">

						@foreach($mvks as $mvk)
			 		
			 			<option value='{{$mvk->id}}'>{{$mvk->name}}</option>
