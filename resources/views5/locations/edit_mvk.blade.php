	        ...
	        <div class="col-md-12" style="height:auto;">
	          ...
	          <div class="panel" id="wizard-form">
	            <div class="panel-heading">
	              <h3 class="panel-title">MVK Details</h3>
	            </div>
	            <div class="panel-body">
	              ...
	              <div class="wizard-content">
		             ...
		             <?php
						...
						$panchayats=DB::table('panchayats')->where('mandal_id','=',$mvk->mandal_id)->get();
					...
					@endforeach
	                 ...
	                 <div class="form-group ">
	                      <label class="control-label" for="mvk_name">MVK( Mitra Vittana Kendra)</label>
	                      <input type="text" class="form-control " id="mvk_name" value="{{$mvk->name}}" name="mvk_name" placeholder="mvk name">
	                </div>
 				</form>
...
<!-- Core  -->
 ...
 {!! Html::script('plugins/bootstrap-select/bootstrap-select.js') !!}
  ...
  {!! Html::script("js/location_dropdown_add_mvk.js") !!}
...
$('.selectpicker').selectpicker('val', [{{str_replace('+',',',$mvk->panchayat_ids) }}]);
      ...
      (function() {
		...
		var url=route_address+"locations/add_mvk/{{$mvk->id}}";
		console.log('post data sent to:'+url);
		var selected_panchayat_id = $('.selectpicker').val();
		...
		$.ajax({
	        ...
	        'selected_panchayat_ids':selected_panchayat_id,
	        'name':$("#mvk_name").val()
