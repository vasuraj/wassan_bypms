					  ...
					  <div class="row">
	                    ...
	                    <div class="form-group col-md-9">
	                      ...
	                      <div class="form-group col-md-3">
		                      ...
		                      <input type="text" class="form-control " id="adhar_card_number" value="{{strtolower($user->adhar_card_number)}}" name="adhar_card_number" placeholder="Aadhar Card Number">
		                    </div>
	                    ...
	                    <div class="form-group">
	                      ...
	                      <input type="text" class="form-control " id="full_address" value="{{strtolower($user->full_address)}}" name="full_address" placeholder="Address of Farmer">
	                    </div>
	         ...
	         <div class="wizard-pane" id="advance-details" role="tabpanel">
				<form id="advance-details-form"  action="">
	                    ...
	                    <div class="form-group">
	                      ...
	                      <input type="text" class="form-control" id="survey_number" name="survey_number" value="{{$user->survey_number}}" placeholder="Survey Number">
	                    </div>     
	                    ...
	                    <hr>
	                     <div class="form-group  col-md-6">
	                      ...
	                      <input type="text" class="form-control" id="bank_name" name="bank_name" value="{{$user->bank_name}}" placeholder="Name of Bank">
	                    </div>
	                     
	                     <div class="form-group  col-md-6">
	                      <label class="control-label" for="bank_location">Location of bank</label>
	                      <input type="text" class="form-control" id="bank_location" name="bank_location" value="{{$user->bank_location}}" placeholder="Location of Bank">
	                    </div>

	                     <div class="form-group  col-md-6">
	                      <label class="control-label" for="bank_ifsc_code">IFSC CODE</label>
	                      <input type="text" class="form-control" id="bank_ifsc_code" name="bank_ifsc_code" value="{{$user->bank_ifsc_code}}" placeholder="IFSC Code">
	                    </div>

	     				<div class="form-group  col-md-6">
	                      <label class="control-label" for="bank_passbook_name">Name in Bank Passbook</label>
	                      <input type="text" class="form-control" id="bank_passbook_name" name="bank_passbook_name"  value="{{$user->bank_passbook_name}}" placeholder="Name in Bank Passbook">
	                    </div>
	                     ...
	                     <div class="form-group  col-md-6">
	                      ...
	                      <input type="text" class="form-control" id="bank_account_number" name="bank_account_number" value="{{$user->bank_account_number}}" placeholder="Account Number">
	                    </div>
...
{!! Html::script('plugins/croppic/croppic.min.js')	!!}
  ...
  {!! Html::script("js/location_dropdown_mvk_for_edit.js") !!}
