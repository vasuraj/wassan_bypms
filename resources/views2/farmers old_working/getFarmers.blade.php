                  ...
                  <!-- table-menu button -->
                               <div class="btn-toolbar" aria-label="Toolbar with button groups" role="toolbar">
                                    <div class="btn-group" style="width:72px;"role="group">
                                      <button type="button" class="btn  btn-default" style="width:30px; padding:5px 7px; "><a target="_blank" href="{{URL::to('farmer/'.$farmer->id.'/edit')}}"><i class="icon wb-pencil" aria-hidden="true"></a></i></button>
