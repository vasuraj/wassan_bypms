	          ...
	          <div class="panel" id="wizard-form">
	            <div class="panel-heading">
	              <h3 class="panel-title">Farmer Details
				   ...
				   <div style="font-size:12px; background:#e3e3e3; padding:5px; border-radius:5px; max-width:350px;" > 
						<i class="fa fa-map-marker" aria-hidden="true"></i>
	                	{{ $farmers_location_insert['state'][0]}} <i class="fa fa-caret-right" aria-hidden="true"></i>
	                	{{ $farmers_location_insert['district'][0]}} <i class="fa fa-caret-right" aria-hidden="true"></i>
	                	{{ $farmers_location_insert['mandal'][0]}} <i class="fa fa-caret-right" aria-hidden="true"></i>
...
<script>
  ...
  $("#advance-details-form").formValidation({
		...
		$.ajax({
	        ...
	        'village':'{{ $farmers_location_insert["village"][0]}}',
	        'name':$("#name").val(),
	        'fname':$("#fname").val(),
