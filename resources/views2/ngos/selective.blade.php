  ...
  $(function(){
    ...
    var route_address=base_url+sub_domain+'/';
      ...
      $('#get_records').on('click',function(){
       ...
       var url=route_address+'ngo/getselective/'+selected_state_name+'/'+selected_district_name+'/'+selected_mandal_name+'/'+selected_mvk_name+'/'+selected_panchayat_name+'/'+selected_village_name+'/'+selected_habitation_name;
