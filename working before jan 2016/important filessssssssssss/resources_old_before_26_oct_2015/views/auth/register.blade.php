...
{!! Form::open(array('url'=>'auth/register', 'method'=>'post', 'class'=>'form-horizontal')) !!}
    ...
    {!! Form::text('name', old('name'), array('class'=>'form-control form-group ', 'placeholder'=>'Name'))  !!}
    ...
    {!! Form::password('password_confirmation', array('class'=>'form-control form-group ', 'placeholder'=>'confirm password'))  !!}

    {!! Form::submit('Register Me', array('class'=>'form-control form-group  btn-success')) !!}
