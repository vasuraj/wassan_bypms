...
<head>
  ...
  <title>[BSI]| Business Services and Information center</title>
  ...
  <nav class="site-navbar navbar navbar-default navbar-fixed-top navbar-mega" role="navigation">
    ...
    <div class="navbar-header">
      ...
      <div class="navbar-brand navbar-brand-center site-gridmenu-toggle" data-toggle="gridmenu">
        <img class="navbar-brand-logo" src="{{asset('images/logo.png')}}" title="BSI">
        <span class="navbar-brand-text">BSI</span>
      </div>
    </div>
...
<ul  class="list-icons" >
          <li><a href="{{ url('/') }}">Home</a></li>
                    @if (Auth::check())
                    <li><i class="wb-chevron-right-mini" aria-hidden="true"></i><a href="{{ url('/dashboard') }}">Dashboard</a></li>
                 
                    <li><i class="wb-chevron-right-mini" aria-hidden="true"></i><a href="{{ url('/role_permission') }}">Panel</a></li>

                    @if(Entrust::user()->hasRole('admin'))
                    <li><i class="wb-chevron-right-mini" aria-hidden="true"></i><a href="{{ URL::route('roles.index') }}">Roles</a></li>
                    <li><i class="wb-chevron-right-mini" aria-hidden="true"></i><a href="{{ URL::route('users.index') }}">Users</a></li>

                    @endif

                    @if(Entrust::user()->hasRole('admin') || Entrust::user()->hasRole('editor'))
                    <li><i class="wb-chevron-right-mini" aria-hidden="true"></i><a href="{{ URL::route('permissions.index') }}">Permissions</a></li>
                    @endif
        ...
        <ul class="nav navbar-toolbar navbar-right navbar-toolbar-right">
          ...
          <a style="float:left; background:#fff; color:#89bceb;  padding:0px 5px; border:3px solid #89bceb;; border-radius:100px; margin-top:15px;   " id="start_tour" href="javascript:void(0)">
          <li class="icon wb-help" aria-hidden="true"></li></a>
  ...
  <footer class="site-footer">
    <span class="site-footer-legal">© 2015 BSI</span>
    <div class="site-footer-right">
      Crafted with <i class="red-600 wb wb-heart"></i> by <a href="mailto:vishnu27990@gmail.com">Vishnu Prabhakar Rajoria</a>
    </div>
  </footer>
